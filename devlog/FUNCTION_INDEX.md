...
> 机器生成（2026-08-13），由 `node scripts/gen-function-index.js` 产出。共 **2015** 个函数。
...
| `createHairTopologyGeometry` | 7900 | function |  | 4 |
| `createHairTopologyOverlay` | 7921 | function |  | 3 |
| `groupDefaultsFor` | 7968 | function |  | 7 |
| `creationToolActive` | 7975 | function |  | 5 |
| `activeCreationShapeDefaults` | 7979 | function |  | 6 |
| `curvePolylineLength` | 7986 | function |  | 2 |
| `curvePolylineLengths` | 7994 | function |  | 3 |
| `samplePolylineDistance` | 8002 | function |  | 2 |
| `applyProjectedCurveLength` | 8012 | function |  | 4 |
| `clearRegionLengthBaseline` | 8043 | function |  | 2 |
| `ensureRegionLengthBaseline` | 8050 | function |  | 2 |
| `setGroupLengthScale` | 8058 | function |  | 2 |
| `applyGroupDefaultsToExistingStrands` | 8096 | function |  | 3 |
| `requestGroupDefaultsWarning` | 8128 | function |  | 1 |
| `activeProfileOffset` | 8140 | function |  | 3 |
| `profileToCanvas` | 8148 | function |  | 1 |
| `renderProfilePreview` | 8155 | function |  | 7 |
| `renderHairCardCoveragePath` | 8174 | function |  | 2 |
| `updateViewportStatsVisibility` | 8692 | function |  | 1 |
| `canvasToProfile` | 8711 | function |  | 2 |
| `addLock` | 8726 | function |  | 4 |
| `mirroredVector` | 8948 | function |  | 12 |
| `mirroredPlacementFrame` | 8952 | function |  | 2 |
| `mirrorPartnerFor` | 8965 | function |  | 28 |
| `decoupleMirrorPartner` | 8969 | function |  | 2 |
| `createMirrorPartner` | 8977 | function |  | 3 |
| `createMirrorPartnerForNewLock` | 9083 | function |  | 1 |
| `syncMirrorPartnerFromLock` | 9102 | function |  | 3 |
| `syncActiveMirror` | 9284 | function |  | 22 |
| `setMirrorXEditing` | 9296 | function |  | 5 |
| `snapshotState` | 9320 | function |  | 5 |
| `pushUndoState` | 9668 | function |  | 68 |
| `undoLastAction` | 9676 | function |  | 2 |
| `redoLastAction` | 9695 | function |  | 2 |
| `updateHistoryButtons` | 9714 | function |  | 5 |
| `resetTransientInteractionsForStateRestore` | 9719 | function |  | 2 |
| `resetEditableSceneForStateRestore` | 9739 | function |  | 2 |
| `restoreSharedStateForStateRestore` | 9746 | function |  | 2 |
| `restoreSceneCollectionsForStateRestore` | 9786 | function |  | 2 |
| `validateSelectionAfterStateRestore` | 9812 | function |  | 2 |
| `reapplySelectionAfterStateRestore` | 9844 | function |  | 2 |
| `finalizeStateRestore` | 9885 | function |  | 2 |
| `restoreState` | 9892 | function |  | 3 |
| `disposeAllEditableObjects` | 9916 | function |  | 2 |
| `restoreLock` | 9937 | function |  | 2 |
| `restoreGuide` | 10171 | function |  | 2 |
| `vectorToData` | 10232 | function |  | 15 |
| `dataToVector` | 10236 | function |  | 14 |
| `frameToData` | 10266 | function |  | 2 |
| `frameFromData` | 10278 | function |  | 2 |
| `average` | 10290 | function |  | 3 |
| `fitPointAttributes` | 10294 | function |  | 5 |
| `rebuildCurveObjects` | 10323 | function |  | 4 |
| `createCurvePoints` | 10335 | function |  | 2 |
| `deselectStrands` | 10439 | function |  | 9 |
| `beginSelectionMarquee` | 10454 | function |  | 3 |
| `beginAltOrbit` | 10478 | function |  | 1 |
| `beginBlenderNavigation` | 10495 | function |  | 1 |
| `endBlenderNavigation` | 10545 | function |  | 1 |
| `prepareSelectPointerCapture` | 10553 | function |  | 1 |
| `endSelectPointerCapture` | 10559 | function |  | 1 |
| `applyAltClickCandidate` | 10565 | function |  | 2 |
| `finishBrushAltClick` | 10591 | function |  | 1 |
| `endAltOrbit` | 10604 | function |  | 2 |
| `dollyCameraByDrag` | 10611 | function |  | 2 |
| `fastDragMagnitude` | 10634 | function |  | 2 |
| `beginHoudiniZoomDrag` | 10640 | function |  | 1 |
| `updateHoudiniZoomDrag` | 10648 | function |  | 1 |
| `endHoudiniZoomDrag` | 10665 | function |  | 1 |
| `updateSelectionMarquee` | 10673 | function |  | 1 |
| `pointInsideSelectionMarquee` | 10690 | function |  | 3 |
| `selectPointsInMarquee` | 10698 | function |  | 2 |
| `pointKey` | 10724 | arrow |  | 2 |
| `objectSelectionScreenBounds` | 10755 | function |  | 2 |
| `objectInsideSelectionMarquee` | 10792 | function |  | 3 |
| `projectedPoint` | 10809 | arrow |  | 1 |
| `selectObjectsInMarquee` | 10838 | function |  | 2 |
| `finishSelectionMarquee` | 10883 | function |  | 2 |
| `strandSplitProfileData` | 10907 | function |  | 2 |
| `strandSplitControlPoint` | 10920 | function |  | 1 |
| `panelSplitControlPoint` | 10956 | function |  | 3 |
| `panelWidthAt` | 10973 | arrow |  | 3 |
| `panelThicknessAt` | 10980 | arrow |  | 3 |
| `strandControlPointRaycast` | 11013 | function |  | 1 |
| `strandControlPointFrame` | 11048 | function |  | 4 |
| `strandControlPointHitFromEvent` | 11080 | function |  | 3 |
| `createCurveObjects` | 11138 | function |  | 4 |
| `createDimensionEdgeLines` | 11167 | arrow |  | 2 |
| `strandWidthEdgeFrameAt` | 11283 | function |  | 5 |
| `transportedStrandWidthEdgeFrame` | 11290 | function |  | 2 |
| `strandWidthEdgeSample` | 11299 | function |  | 3 |
| `strandWidthEdgePoints` | 11334 | function |  | 2 |
| `moveCurveControlsApplicable` | 11348 | function |  | 5 |
| `moveGrabHandlesApplicable` | 11358 | function |  | 2 |
| `moveGrabHandleVisible` | 11368 | function |  | 2 |
| `visibleTaperMeshCurveEdits` | 11373 | function |  | 1 |
| `syncMoveCurveControls` | 11394 | function |  | 8 |
| `syncAuthoredCheckbox` | 11409 | arrow |  | 3 |
| `setMoveGrabHandleVisibility` | 11429 | function |  | 4 |
| `setMoveCurveControlVisibility` | 11437 | function |  | 4 |
| `setSelectedMoveCurveShapeFlag` | 11446 | function |  | 4 |
| `sculptBrushDebugRaycast` | 11460 | arrow |  | 0 |
| `updateCurveObjects` | 11462 | function |  | 27 |
| `pointUpDirection` | 11667 | function |  | 2 |
| `curveFrameAtPoint` | 11671 | function |  | 4 |
| `curveFrameAt` | 11692 | function |  | 3 |
| `strandTwistAt` | 11712 | function |  | 6 |
| `controlPointRotationAt` | 11717 | function |  | 3 |
| `strandProfileTwistAt` | 11721 | function |  | 2 |
| `strandFrameAt` | 11727 | function |  | 1 |
| `curveFrameAtSnapshot` | 11733 | function |  | 3 |
| `outwardNormalAtPoint` | 11752 | function |  | 5 |
| `sampledSurfaceNormal` | 11815 | function |  | 2 |
| `guidedNormalAt` | 11831 | function |  | 4 |
| `twistFromHandle` | 11850 | function |  | 3 |
| `signedAngleAroundAxis` | 11871 | function |  | 4 |
| `handleColor` | 11878 | function |  | 2 |
| `isAffectedCurvePoint` | 11901 | function |  | 2 |
| `syncLockFromCurve` | 11907 | function |  | 14 |
| `rebuildLockGeometry` | 11937 | function |  | 18 |
| `flushPendingLockGeometryUpdates` | 11961 | function |  | 6 |
| `updateLockGeometry` | 11974 | function |  | 28 |
| `setGroupColorView` | 11995 | function |  | 2 |
| `createUvCheckerTexture` | 12005 | function |  | 3 |
| `ensureUvCheckerForLock` | 12041 | function |  | 3 |
| `removeUvCheckerFromLock` | 12074 | function |  | 3 |
| `invalidateUvInspector` | 12089 | function |  | 7 |
| `uvInspectorRecord` | 12093 | function |  | 1 |
| `uvInspectorRecords` | 12132 | function |  | 2 |
| `drawUvInspectorGrid` | 12136 | function |  | 2 |
| `renderUvInspector` | 12170 | function |  | 3 |
| `setUvCheckerEnabled` | 12229 | function |  | 3 |
| `strandViewportBaseColor` | 12246 | function |  | 2 |
| `strandMirrorPartnerHighlighted` | 12281 | function |  | 3 |
| `syncStrandSelectionOutline` | 12287 | function |  | 2 |
| `applyLockedStrandPalette` | 12298 | function |  | 2 |
| `syncLockedStrandWireVisual` | 12307 | function |  | 5 |
| `setStrandSelectionVisual` | 12316 | function |  | 4 |
| `updateStrandSelectionHighlightForLock` | 12334 | function |  | 1 |
| `updateStrandSelectionHighlight` | 12338 | function |  | 6 |
| `refreshStrandCurveSelectionVisuals` | 12342 | function |  | 2 |
| `resetGuideSelectionVisuals` | 12355 | function |  | 2 |
| `refreshStrandSelectionConsumers` | 12375 | function |  | 3 |
| `selectLock` | 12410 | function |  | 24 |
| `deselectStrandsForGuideEditor` | 12472 | function |  | 1 |
| `syncGroupInputs` | 12483 | function |  | 2 |
| `topologyStatsForLock` | 12516 | function |  | 4 |
| `formatTopologyStats` | 12524 | function |  | 5 |
| `updateTopologyStats` | 12528 | function |  | 15 |
| `normalizeStrandDimensions` | 12562 | function |  | 3 |
| `strandBaseWidth` | 12576 | function |  | 5 |
| `strandWidthDimension` | 12580 | function |  | 5 |
| `strandDepthDimension` | 12588 | function |  | 8 |
| `setStrandWidthDimension` | 12596 | function |  | 2 |
| `setStrandDepthDimension` | 12618 | function |  | 4 |
| `syncShapeDimensionInputs` | 12634 | function |  | 4 |
| `syncCreationShapeInputs` | 12670 | function |  | 2 |
| `syncViewportDrawSettings` | 12709 | function |  | 4 |
| `syncViewportTopControlRows` | 12724 | function |  | 6 |
| `syncResponsiveSidebarDock` | 12744 | function |  | 2 |
| `syncStrandSplitInputs` | 12777 | function |  | 4 |
| `currentStrandTipChain` | 12787 | function |  | 5 |
| `currentStrandTipLength` | 12794 | function |  | 2 |
| `syncStrandTipInputs` | 12803 | function |  | 4 |
| `currentStrandSplitTipChains` | 12818 | function |  | 4 |
| `restPointAt` | 12837 | arrow |  | 0 |
| `currentStrandSplitTipLength` | 12853 | function |  | 2 |
| `syncStrandSplitTipInputs` | 12864 | function |  | 3 |
| `syncHairCardControls` | 12875 | function |  | 6 |
| `updateAttributeEditorMode` | 12884 | function |  | 10 |
| `pinActiveToolSettingsPanel` | 13039 | function |  | 2 |
| `curveLatticeForGroup` | 13062 | function |  | 2 |
| `filterCurveLatticesToGroup` | 13080 | function |  | 5 |
| `createStandaloneCurveLatticeGuide` | 13125 | function |  | 2 |
| `showCurveLatticeForGroup` | 13142 | function |  | 2 |
| `selectStrandGroup` | 13179 | function |  | 3 |
| `selectCurvePoint` | 13221 | function |  | 3 |
| `updateSelectedPointLabel` | 13235 | function |  | 12 |
| `syncInputs` | 13248 | function |  | 13 |
| `getSelectedLock` | 13296 | function |  | 99 |
| `selectedLocksInOrder` | 13300 | function |  | 26 |
| `lockStrands` | 13306 | function |  | 3 |
| `lockSelectedStrands` | 13339 | function |  | 2 |
| `unlockStrands` | 13345 | function |  | 3 |
| `unlockAllStrands` | 13360 | function |  | 2 |
| `strandEditFamily` | 13364 | function |  | 7 |
| `compatibleSelectedLocks` | 13369 | function |  | 5 |
| `selectedEditRoots` | 13376 | function |  | 2 |
| `editSelectedLocks` | 13389 | function |  | 18 |
| `multiEditValuesEqual` | 13422 | function |  | 2 |
| `setMixedControl` | 13431 | function |  | 29 |
| `syncMultiStrandInputs` | 13448 | function |  | 18 |
| `values` | 13464 | arrow |  | 35 |
| `selectedRebuildableCurves` | 13545 | function |  | 5 |
| `createCompoundStrand` | 13552 | function |  | 1 |
| `refreshRebuildCurveDialog` | 13613 | function |  | 7 |
| `openRebuildCurveDialog` | 13626 | function |  | 1 |
| `rebuildSelectedCurves` | 13640 | function |  | 2 |
| `cleanSelectionSets` | 13681 | function |  | 2 |
| `createSelectionSetFromSelection` | 13686 | function |  | 2 |
| `selectionSetById` | 13697 | function |  | 5 |
| `selectionSetCanEditFromSelection` | 13701 | function |  | 7 |
| `editSelectionSetFromSelection` | 13710 | function |  | 4 |
| `closeSelectionSetMembershipDialog` | 13730 | function |  | 3 |
| `openSelectionSetMembershipDialog` | 13736 | function |  | 3 |
| `deleteSelectionSet` | 13768 | function |  | 2 |
| `selectSelectionSet` | 13777 | function |  | 2 |
| `deleteSelectedStrands` | 13787 | function |  | 3 |
| `deleteGuide` | 13795 | function |  | 3 |
| `deleteSelectedGuide` | 13818 | function |  | 3 |
| `hasDeletableSelection` | 13823 | function |  | 2 |
| `deleteCurrentSelection` | 13831 | function |  | 3 |
| `hideOutlinerContextMenu` | 13839 | function |  | 16 |
| `outlinerLockTargets` | 13844 | function |  | 3 |
| `showOutlinerContextMenu` | 13871 | function |  | 6 |
| `setPullMoveEnabled` | 13968 | function |  | 2 |
| `setNavigationTipsEnabled` | 13977 | function |  | 4 |
| `configureNavigationMouseButtons` | 13984 | function |  | 3 |
| `syncNavigationModifierLocks` | 13997 | function |  | 7 |
| `setNavigationStyle` | 14002 | function |  | 4 |
| `applyCameraSmoothingPreference` | 14018 | function |  | 4 |
| `setCameraSmoothingEnabled` | 14033 | function |  | 4 |
| `setCameraSmoothingStrength` | 14039 | function |  | 4 |
| `setScaleSensitivity` | 14047 | function |  | 3 |
| `setToolTipsEnabled` | 14055 | function |  | 4 |
| `setCompactToolButtonsEnabled` | 14062 | function |  | 4 |
| `setViewportStatisticsEnabled` | 14071 | function |  | 4 |
| `setTwistCurveAllStrandsPreviewEnabled` | 14079 | function |  | 4 |
| `setLayerColorShiftsEnabled` | 14094 | function |  | 4 |
| `setOutlinerFolderColorsEnabled` | 14103 | function |  | 4 |
| `setSidePanelStyle` | 14113 | function |  | 5 |
| `setGlassPanelColor` | 14131 | function |  | 6 |
| `setOutlinerFolderColorOpacity` | 14141 | function |  | 5 |
| `sideNamingDisplayId` | 14158 | function |  | 2 |
| `strandRegionDisplayLabel` | 14171 | function |  | 6 |
| `updateSideNamingLabels` | 14189 | function |  | 2 |
| `setSideNamingPerspective` | 14216 | function |  | 4 |
| `setControlPointDisplaySize` | 14225 | function |  | 5 |
| `scaleHexColor` | 14237 | function |  | 3 |
| `setViewportBackgroundColor` | 14242 | function |  | 6 |
| `setDefaultHairShader` | 14264 | function |  | 4 |
| `setPreferenceCategory` | 14270 | function |  | 4 |
| `openPreferencesDialog` | 14297 | function |  | 1 |
| `savePreferencesDialog` | 14336 | function |  | 1 |
| `cancelPreferencesDialog` | 14366 | function |  | 3 |
| `createOutlinerStrandButton` | 14406 | function |  | 2 |
| `createOutlinerCurveSurface` | 14492 | function |  | 2 |
| `selectionSetMatchesCurrentSelection` | 14589 | function |  | 2 |
| `createSelectionSetsOutlinerFolder` | 14596 | function |  | 2 |
| `renderLockList` | 14675 | function |  | 37 |
| `updateCount` | 14856 | function |  | 10 |
| `captureInputUndo` | 14865 | function |  | 1 |
| `bindUndoCapture` | 14871 | function |  | 41 |
| `bindLockInput` | 14882 | function |  | 2 |
| `applyValue` | 14899 | arrow |  | 2 |
| `applyUniformTransformScale` | 15234 | function |  | 2 |
| `applyReducedTransformScale` | 15251 | function |  | 2 |
| `applyTransformPrecision` | 15290 | function |  | 2 |
| `updateTransformScalePointer` | 15319 | function |  | 1 |
| `syncDrawCurlControls` | 16394 | function |  | 5 |
| `handleLiveSurfaceChange` | 16442 | function |  | 1 |
| `applyStrandTipToTarget` | 16502 | function |  | 5 |
| `strandTipTarget` | 16513 | function |  | 5 |
| `strandSplitTipTarget` | 16586 | function |  | 3 |
| `applyStrandSplitTipToTarget` | 16591 | function |  | 3 |
| `selectedBranchChildLock` | 16883 | function |  | 4 |
| `updateBranchBridgeSliderInputs` | 16887 | function |  | 2 |
| `updateSweepOverlapSliderInputs` | 16928 | function |  | 2 |
| `initPanelResizeHandles` | 17095 | function |  | 2 |
| `applyWidth` | 17101 | arrow |  | 2 |
| `restoreWidth` | 17108 | arrow |  | 2 |
| `bindResize` | 17116 | arrow |  | 2 |
| `onMove` | 17125 | arrow |  | 0 |
| `onUp` | 17129 | arrow |  | 0 |
| `updateSnappedFloatingPanels` | 17146 | function |  | 2 |
| `initFloatingPanelControls` | 17155 | function |  | 2 |
| `detach` | 17164 | arrow |  | 22 |
| `endDrag` | 17202 | arrow |  | 0 |
| `endResize` | 17234 | arrow |  | 0 |
| `updateSculptBrushDockCompact` | 17245 | function |  | 3 |
| `selectPatchNotesVersion` | 17404 | function |  | 3 |
| `toggleCapsuleGuideTool` | 17635 | function |  | 1 |
| `activateCapsuleGuideDrawTool` | 17641 | function |  | 1 |
| `createCurveLatticeGuideFromUi` | 17648 | function |  | 1 |
| `deleteLocks` | 18215 | function |  | 4 |
| `disposeCurveObjects` | 18293 | function |  | 4 |
| `activateMultiCameraView` | 18340 | arrow |  | 1 |
| `resize` | 18372 | function |  | 6 |
| `handleViewportPointerMove` | 18398 | function |  | 1 |
| `blockProportionalSizingEvent` | 18409 | function |  | 1 |
| `updateLightAngleFromInputs` | 18415 | function |  | 2 |
| `startViewSnap` | 18429 | function |  | 3 |
| `beginViewSnapFromActiveOrbit` | 18459 | function |  | 3 |
| `trackViewportPointerDown` | 18476 | function |  | 1 |
| `trackViewportPointerMove` | 18492 | function |  | 1 |
| `clearViewportPointer` | 18500 | function |  | 1 |
| `updateViewSnap` | 18505 | function |  | 1 |
| `nearestCardinalAxis` | 18541 | function |  | 6 |
| `cardinalAxisKey` | 18555 | function |  | 6 |
| `steppedDragAmount` | 18559 | function |  | 3 |
| `snapCameraToCardinalAxis` | 18565 | function |  | 5 |
| `endViewSnap` | 18581 | function |  | 4 |
| `updateCameraViewCube` | 18600 | function |  | 3 |
| `activateView` | 18618 | function |  | 1 |
| `activateStrandControlPoint` | 18643 | function |  | 2 |
| `refreshStrandControlPointSelection` | 18693 | function |  | 4 |
| `addStrandControlPointSelection` | 18720 | function |  | 2 |
| `removeStrandControlPointSelection` | 18737 | function |  | 3 |
| `sampleStrandPointNormal` | 18751 | function |  | 2 |
| `sampleStrandPointVectors` | 18761 | function |  | 3 |
| `remapStrandPointSelectionAfterRemoval` | 18767 | function |  | 2 |
| `resampleStrandCurveData` | 18778 | function |  | 4 |
| `resampleMatchingVectors` | 18784 | arrow |  | 3 |
| `finishStrandCurveTopologyChange` | 18823 | function |  | 4 |
| `removeStrandCurvePoint` | 18834 | function |  | 2 |
| `closestStrandCurveParameter` | 18847 | function |  | 1 |
| `insertStrandCurvePoint` | 18876 | function |  | 2 |
| `curvePointTopologyCursorAvailable` | 18893 | function |  | 2 |
| `selectionModifierCursorAvailable` | 18903 | function |  | 3 |
| `clearCurvePointTopologyCursor` | 18919 | function |  | 6 |
| `updateCurvePointTopologyCursor` | 18926 | function |  | 4 |
| `finishCurvePointInsertion` | 18949 | function |  | 1 |
| `finishPointRemoval` | 18964 | function |  | 1 |
| `isHairCreateTool` | 18983 | function |  | 4 |
| `syncStrandHoverOutline` | 18987 | function |  | 1 |
| `pointerOverTaperEditor` | 19000 | function |  | 2 |
| `updateStrandBrushHover` | 19007 | function |  | 1 |
| `strandControlPointHit` | 19031 | function |  | 3 |
| `beginStrandWidthEdgeDrag` | 19035 | function |  | 1 |
| `updateStrandWidthEdgeDrag` | 19113 | function |  | 1 |
| `finishStrandWidthEdgeDrag` | 19147 | function |  | 2 |
| `setHoveredStrandWidthEdge` | 19187 | function |  | 8 |
| `updateStrandWidthEdgeHover` | 19200 | function |  | 1 |
| `setHoveredControlPoint` | 19239 | function |  | 7 |
| `visibleControlPointHoverTargets` | 19252 | function |  | 2 |
| `updateControlPointHover` | 19288 | function |  | 1 |
| `animate` | 19907 | function |  | 2 |
| `syncCompactSidebarLayout` | 19943 | function |  | 4 |
| `setOutlinerPanelCollapsed` | 19962 | function |  | 5 |
| `setAttributeEditorPanelCollapsed` | 19968 | function |  | 3 |
| `setAttributeEditorTab` | 19974 | function |  | 6 |
...
## modules/geometry/strand-geometry.js（1162 行）
...
| `createHairCardGeometry` | 425 | function |  | 2 |
| `createPolyGeometry` | 576 | function |  | 2 |
| `createConnectedCurveCardGeometry` | 603 | function |  | 4 |
| `createCompoundStrandGeometry` | 668 | function |  | 2 |
| `vertexIndex` | 753 | arrow |  | 6 |
| `proceduralBranchGeometryLock` | 919 | function |  | 2 |
| `createHairGeometry` | 950 | function |  | 1 |
| `createBaseHairGeometry` | 1002 | function |  | 3 |
