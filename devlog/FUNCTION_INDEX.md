...
| 函数 | 行号 | 类型 | 导出 | calls |
|---|---|---|---|---|
| `saveLanguage` | 283 | function |  | 3 |
| `saveBooleanPreference` | 311 | function |  | 20 |
| `normalizeControlPointDisplaySize` | 315 | function |  | 2 |
| `normalizeCameraSmoothingStrength` | 320 | function |  | 2 |
| `normalizeScaleSensitivity` | 325 | function |  | 2 |
| `normalizeViewportBackgroundColor` | 330 | function |  | 2 |
| `normalizeSideNamingPerspective` | 335 | function |  | 2 |
| `normalizeNavigationStyle` | 339 | function |  | 2 |
| `setupEditableSliderControls` | 354 | function |  | 2 |
| `syncNumberFromRange` | 405 | arrow |  | 0 |
| `applyNumberValue` | 412 | arrow |  | 0 |
| `copyCameraPose` | 518 | function |  | 3 |
| `updateCameraProjectionForViewport` | 524 | function |  | 4 |
| `syncOrthographicFramingFromDistance` | 537 | function |  | 2 |
| `setOrthographicView` | 543 | function |  | 2 |
| `addNegativeTransformGizmoRods` | 583 | function |  | 2 |
| `addFullRotateGizmoAxisCircles` | 612 | function |  | 2 |
| `removeRotateFreeAxisRing` | 638 | function |  | 2 |
| `deflateTransformGizmoPickers` | 650 | function |  | 2 |
| `nextStrandName` | 1045 | function |  | 2 |
| `isPanelGeometry` | 1271 | function |  | 29 |
| `normalizePanelSplits` | 1275 | function |  | 2 |
| `clonePanelSplits` | 1287 | function |  | 11 |
| `snapPanelSplitHeight` | 1291 | function |  | 3 |
| `createQuadSphereGeometry` | 1326 | function |  | 2 |
| `vertexIndex` | 1340 | function |  | 5 |
| `addEdge` | 1358 | function |  | 5 |
| `setDrawStrandBrushCursorScale` | 1575 | function |  | 4 |
| `ensureDrawClumpPreviewCount` | 1755 | function |  | 1 |
| `currentStrandSelectionState` | 1817 | function |  | 4 |
| `applyStrandSelectionState` | 1821 | function |  | 5 |
| `clearStrandSelectionState` | 1826 | function |  | 5 |
| `normalizeHairLayer` | 3028 | function |  | 25 |
| `layerOffsetForLock` | 3032 | function |  | 8 |
| `layerRootOffsetFactor` | 3037 | function |  | 12 |
| `layerOffsetWeight` | 3041 | function |  | 4 |
| `applyLayerOffsetDeltaToPoints` | 3047 | function |  | 5 |
| `pointsWithLayerOffset` | 3056 | function |  | 1 |
| `layerDirectionForLock` | 3064 | function |  | 2 |
| `applyLayerOffset` | 3075 | function |  | 5 |
| `setLockHairLayer` | 3099 | function |  | 2 |
| `setGroupLayerOffset` | 3114 | function |  | 2 |
| `quadraticWeights` | 3142 | function |  | 1 |
| `templatePlaneIntersectionSegments` | 3343 | function |  | 1 |
| `upperContourCurve` | 3360 | function |  | 2 |
| `hermitePoint` | 3395 | function |  | 2 |
| `curveNetworkSection` | 3406 | function |  | 1 |
| `pointAlongSection` | 3435 | function |  | 1 |
| `longestStitchedContour` | 3441 | function |  | 2 |
| `nodeForPoint` | 3449 | arrow |  | 2 |
| `constructionCurveFromSegments` | 3506 | function |  | 1 |
| `exitSetupEditors` | 3526 | function |  | 6 |
| `syncAppMenuVisibility` | 3536 | function |  | 3 |
| `closeAppMenus` | 3542 | function |  | 6 |
| `setAppMenuOpen` | 3553 | function |  | 2 |
| `setTurntableActive` | 3560 | function |  | 3 |
| `setOutlinerTab` | 3599 | function |  | 7 |
| `effectiveViewportSelectionMode` | 3617 | function |  | 4 |
| `componentEditModeActive` | 3621 | function |  | 28 |
| `selectionToolSupportsPicking` | 3625 | function |  | 3 |
| `syncViewportSelectionModeControl` | 3630 | function |  | 4 |
| `refreshSelectionModeVisuals` | 3646 | function |  | 2 |
| `setViewportSelectionMode` | 3676 | function |  | 3 |
| `setViewportEditMode` | 3688 | function |  | 7 |
| `createOutlinerVisibilityToggle` | 3730 | function |  | 6 |
| `setLocksOutlinerVisibility` | 3744 | function |  | 8 |
| `normalizeOutlinerName` | 3758 | function |  | 3 |
| `beginOutlinerRename` | 3763 | function |  | 2 |
| `finish` | 3774 | arrow |  | 3 |
| `handleOutlinerRenameClick` | 3804 | function |  | 5 |
| `strandPassesDisplayFilters` | 3954 | function |  | 4 |
| `strandVisibleForDisplay` | 3963 | function |  | 9 |
| `strandAvailableForViewportInteraction` | 3968 | function |  | 3 |
| `lockedStrandsExist` | 3972 | function |  | 1 |
| `hiddenStrandsExist` | 3976 | function |  | 1 |
| `hideSelectedStrands` | 3980 | function |  | 1 |
| `unhideHiddenStrands` | 3990 | function |  | 1 |
| `strandIsolationActive` | 3999 | function |  | 4 |
| `setStrandIsolation` | 4003 | function |  | 3 |
| `toggleSelectedStrandIsolation` | 4015 | function |  | 2 |
| `syncVisibilityParent` | 4026 | function |  | 4 |
| `syncDisplayVisibilityInputs` | 4033 | function |  | 7 |
| `applyCharacterMeshDisplayVisibility` | 4062 | function |  | 4 |
| `applyStrandDisplayVisibility` | 4069 | function |  | 4 |
| `applyDisplayVisibilityFilters` | 4092 | function |  | 8 |
| `updateGroupCurveLatticeStrands` | 4310 | function |  | 2 |
| `updateBoundCurveLatticeStrands` | 4331 | function |  | 1 |
| `createStrandsFromCurveLattice` | 4350 | function |  | 2 |
| `selectedViewportFocusBounds` | 4448 | function |  | 2 |
| `frameViewportBounds` | 4462 | function |  | 5 |
| `centerViewportOnSelectedItem` | 4492 | function |  | 2 |
| `fullSceneFocusBounds` | 4496 | function |  | 2 |
| `currentViewportFrameSelectionKey` | 4511 | function |  | 3 |
| `cycleViewportFraming` | 4520 | function |  | 2 |
| `sculptBrushToolActive` | 4540 | function |  | 22 |
| `sculptBrushSelectionMaskActive` | 4544 | function |  | 3 |
| `sculptBrushSelectionAllows` | 4548 | function |  | 2 |
| `effectiveSculptBrushTool` | 4552 | function |  | 3 |
| `updateSculptScaleModeRow` | 4558 | function |  | 4 |
| `syncSculptBrushToolButtons` | 4563 | function |  | 3 |
| `setSculptBrushShiftSmoothHeld` | 4585 | function |  | 5 |
| `setActiveTool` | 4594 | function |  | 11 |
| `setDrawStrandMode` | 4732 | function |  | 1 |
| `setObjectSpaceEditing` | 4742 | function |  | 5 |
| `setHierarchyEditing` | 4758 | function |  | 4 |
| `setProportionalEditing` | 4770 | function |  | 5 |
| `beginProportionalSizeEdit` | 4789 | function |  | 3 |
| `updateProportionalSizeEdit` | 4801 | function |  | 2 |
| `endProportionalSizeEdit` | 4812 | function |  | 5 |
| `activateProportionalHotkeyHold` | 4819 | function |  | 2 |
| `refreshProportionalPreview` | 4827 | function |  | 4 |
| `activeBrushSizeInput` | 4837 | function |  | 2 |
| `refreshActiveBrushSizeCursor` | 4846 | function |  | 3 |
| `refreshActiveBrushSizeScale` | 4858 | function |  | 2 |
| `beginBrushSizeDrag` | 4876 | function |  | 1 |
| `updateBrushSizeDrag` | 4903 | function |  | 1 |
| `finishBrushSizeDrag` | 4924 | function |  | 2 |
| `updateInteractionLocks` | 4941 | function |  | 43 |
| `configureTransformControls` | 4952 | function |  | 11 |
| `pullMoveActive` | 4960 | function |  | 8 |
| `updatePullGuideVisual` | 4964 | function |  | 4 |
| `attachTransformForCurvePoint` | 4980 | function |  | 5 |
| `pointerHitsTransformGizmo` | 5004 | function |  | 5 |
| `strandObjectRootIndex` | 5020 | function |  | 3 |
| `strandObjectRoot` | 5029 | function |  | 4 |
| `strandObjectTransformQuaternion` | 5033 | function |  | 2 |
| `attachStrandObjectTransform` | 5038 | function |  | 6 |
| `guideObjectPivot` | 5061 | function |  | 3 |
| `guideObjectTransformQuaternion` | 5072 | function |  | 2 |
| `attachGuideObjectTransform` | 5077 | function |  | 5 |
| `guideObjectTransformSnapshot` | 5096 | function |  | 2 |
| `beginGuideObjectTransform` | 5124 | function |  | 2 |
| `updateLegacyGuideObjectTransform` | 5131 | function |  | 2 |
| `updateGuideObjectTransform` | 5153 | function |  | 2 |
| `finishGuideObjectTransform` | 5186 | function |  | 2 |
| `clonePlacementFrame` | 5195 | function |  | 2 |
| `cloneOptionalVectors` | 5207 | function |  | 10 |
| `strandObjectTransformSnapshot` | 5211 | function |  | 2 |
| `strandObjectPreviewMeshSnapshot` | 5228 | function |  | 2 |
| `restoreStrandObjectPreviewMeshes` | 5243 | function |  | 2 |
| `strandObjectTransformOperators` | 5259 | function |  | 4 |
| `transformPoint` | 5267 | arrow |  | 12 |
| `transformPointAroundFixedPivot` | 5274 | arrow |  | 0 |
| `transformNormal` | 5280 | arrow |  | 10 |
| `transformDirection` | 5290 | arrow |  | 5 |
| `worldMatrixForPivot` | 5302 | arrow |  | 2 |
| `worldMatrixForFixedPivot` | 5308 | arrow |  | 1 |
| `applyStrandObjectPreviewMatrix` | 5324 | function |  | 6 |
| `beginStrandObjectTransform` | 5350 | function |  | 2 |
| `updateStrandObjectTransform` | 5388 | function |  | 2 |
| `commitStrandObjectTransform` | 5446 | function |  | 2 |
| `mapPoints` | 5459 | arrow |  | 4 |
| `finishStrandObjectTransform` | 5493 | function |  | 2 |
| `surfaceObjectAnchorPose` | 5507 | function |  | 2 |
| `attachSurfaceObjectAnchorTransform` | 5530 | function |  | 5 |
| `selectSurfaceObjectAnchor` | 5543 | function |  | 3 |
| `beginSurfaceObjectTransform` | 5558 | function |  | 2 |
| `updateSurfaceObjectTransform` | 5584 | function |  | 2 |
| `finishSurfaceObjectTransform` | 5633 | function |  | 2 |
| `beginHandleEdit` | 5642 | function |  | 5 |
| `updateGroupLatticeBaseFromHandleEdit` | 5695 | function |  | 3 |
| `multiPointHandleEditActive` | 5706 | function |  | 7 |
| `applyMultiMove` | 5710 | function |  | 5 |
| `applyMultiRotate` | 5716 | function |  | 2 |
| `applyMultiScale` | 5725 | function |  | 2 |
| `applyHierarchicalMove` | 5734 | function |  | 3 |
| `applySingleMove` | 5746 | function |  | 5 |
| `applySurfaceLatticeMirror` | 5750 | function |  | 3 |
| `curveSurfaceMirroredPointIndex` | 5767 | function |  | 2 |
| `syncUnifiedCurveSurfaceMirror` | 5776 | function |  | 3 |
| `changed` | 5786 | arrow |  | 1 |
| `applyPullMove` | 5828 | function |  | 3 |
| `pullHeadCollisionContext` | 5836 | function |  | 2 |
| `constrainPullPointsOutsideHead` | 5855 | function |  | 2 |
| `applyProportionalMove` | 5878 | function |  | 3 |
| `viewPlaneNormal` | 5889 | function |  | 6 |
| `isCameraInSnappedView` | 5893 | function |  | 2 |
| `viewPlaneMoveActiveForView` | 5901 | function |  | 9 |
| `updateViewPlaneGrid` | 5905 | function |  | 13 |
| `setViewPlaneMove` | 5962 | function |  | 3 |
| `setViewPlaneMoveSnappedOnly` | 5973 | function |  | 2 |
| `rayFromViewportEvent` | 5981 | function |  | 9 |
| `worldUnitsPerViewportPixel` | 5989 | function |  | 4 |
| `viewPlaneMovePointNormal` | 5999 | function |  | 2 |
| `updateViewPlaneNormalGuide` | 6010 | function |  | 5 |
| `rebaseViewPlaneMoveDrag` | 6023 | function |  | 3 |
| `setViewPlaneNormalMoveHeld` | 6042 | function |  | 4 |
| `beginViewPlaneMove` | 6049 | function |  | 3 |
| `updateViewPlaneMove` | 6113 | function |  | 1 |
| `endViewPlaneMove` | 6178 | function |  | 7 |
| `applyHierarchicalRotate` | 6197 | function |  | 2 |
| `rotateGuideNormal` | 6204 | arrow |  | 4 |
| `applySingleRotate` | 6242 | function |  | 2 |
| `applyProportionalRotate` | 6246 | function |  | 2 |
| `applyHierarchicalScale` | 6266 | function |  | 2 |
| `applySingleScale` | 6276 | function |  | 2 |
| `applyProportionalScale` | 6280 | function |  | 2 |
| `setPointScale` | 6296 | function |  | 7 |
| `proportionalWeight` | 6305 | function |  | 8 |
| `proportionalStrandVisualsActive` | 6317 | function |  | 5 |
| `strandInfluenceColor` | 6323 | function |  | 4 |
| `beginRelaxEdit` | 6348 | function |  | 3 |
| `updateRelaxEdit` | 6377 | function |  | 1 |
| `endRelaxEdit` | 6437 | function |  | 1 |
| `disposeGuide` | 6447 | function |  | 3 |
| `removeGuideObjects` | 6475 | function |  | 3 |
| `strandRadiusAt` | 6489 | function |  | 5 |
| `strandProfileTopologyAt` | 6506 | function |  | 2 |
| `strandCurveParameters` | 6548 | function |  | 1 |
| `widthProfileAt` | 6558 | arrow |  | 1 |
| `braidFrameAt` | 6596 | function |  | 4 |
| `braidFrameAtExtended` | 6606 | function |  | 2 |
| `createBraidProfileProjector` | 6615 | function |  | 2 |
| `project` | 6631 | arrow |  | 11 |
| `createBraidGeometry` | 6646 | function |  | 1 |
| `quantize` | 6679 | arrow |  | 19 |
| `deformationAt` | 6681 | function |  | 3 |
| `widthFor` | 6690 | arrow |  | 3 |
| `depthFor` | 6694 | arrow |  | 3 |
| `outputVertex` | 6726 | function |  | 7 |
| `appendAuthoredCap` | 6834 | function |  | 3 |
| `outputCapVertex` | 6841 | arrow |  | 6 |
| `capBoundary` | 6932 | function |  | 3 |
| `strandGeometryCurve` | 6994 | function |  | 6 |
| `strandGeometryFrameAt` | 7020 | function |  | 5 |
| `transportedStrandFrameAt` | 7083 | function |  | 5 |
| `twistOverrideAt` | 7086 | arrow |  | 2 |
| `hairMaterialDefinition` | 7156 | function |  | 4 |
| `materialForLock` | 7160 | function |  | 7 |
| `activeHairMaterialDefinition` | 7164 | function |  | 11 |
| `strandDisplayColor` | 7170 | function |  | 13 |
| `setAnimeHairBaseColor` | 7188 | function |  | 3 |
| `createAnimeAnisotropicMaterial` | 7201 | function |  | 2 |
| `createHairMaterial` | 7241 | function |  | 4 |
| `createStrandSelectionOutline` | 7283 | function |  | 5 |
| `strandUsesDoubleSidedMaterial` | 7318 | function |  | 6 |
| `applyMaterialDefinitionToLock` | 7327 | function |  | 6 |
| `refreshMaterialUsers` | 7354 | function |  | 6 |
| `renderHairMaterialOutliner` | 7363 | function |  | 5 |
| `renderHairMaterialOptions` | 7393 | function |  | 3 |
| `syncHairMaterialEditor` | 7403 | function |  | 9 |
| `createProjectHairMaterial` | 7429 | function |  | 3 |
| `deleteActiveHairMaterial` | 7449 | function |  | 2 |
| `createHairTopologyGeometry` | 7467 | function |  | 4 |
| `createHairTopologyOverlay` | 7488 | function |  | 3 |
| `groupDefaultsFor` | 7535 | function |  | 7 |
| `creationToolActive` | 7542 | function |  | 5 |
| `activeCreationShapeDefaults` | 7546 | function |  | 6 |
| `curvePolylineLength` | 7553 | function |  | 2 |
| `curvePolylineLengths` | 7561 | function |  | 3 |
| `samplePolylineDistance` | 7569 | function |  | 2 |
| `applyProjectedCurveLength` | 7579 | function |  | 4 |
| `clearRegionLengthBaseline` | 7610 | function |  | 2 |
| `ensureRegionLengthBaseline` | 7617 | function |  | 2 |
| `setGroupLengthScale` | 7625 | function |  | 2 |
| `applyGroupDefaultsToExistingStrands` | 7663 | function |  | 3 |
| `requestGroupDefaultsWarning` | 7695 | function |  | 1 |
| `activeProfileOffset` | 7707 | function |  | 3 |
| `profileToCanvas` | 7715 | function |  | 1 |
| `renderProfilePreview` | 7722 | function |  | 7 |
| `renderHairCardCoveragePath` | 7741 | function |  | 2 |
| `updateViewportStatsVisibility` | 8132 | function |  | 1 |
| `canvasToProfile` | 8151 | function |  | 2 |
| `addLock` | 8166 | function |  | 4 |
| `mirroredVector` | 8378 | function |  | 12 |
| `mirroredPlacementFrame` | 8382 | function |  | 2 |
| `mirrorPartnerFor` | 8395 | function |  | 34 |
| `decoupleMirrorPartner` | 8399 | function |  | 2 |
| `createMirrorPartner` | 8407 | function |  | 5 |
| `createMirrorPartnerForNewLock` | 8503 | function |  | 3 |
| `mirroredClumpPartners` | 8508 | function |  | 3 |
| `createMirroredClump` | 8514 | function |  | 2 |
| `decoupleMirroredClump` | 8536 | function |  | 2 |
| `syncMirrorPartnerFromLock` | 8556 | function |  | 5 |
| `syncActiveMirror` | 8723 | function |  | 20 |
| `setMirrorXEditing` | 8735 | function |  | 5 |
| `snapshotState` | 8759 | function |  | 6 |
| `rootAttachmentFrame` | 9020 | function |  | 3 |
| `rootAttachmentLocalFrame` | 9032 | function |  | 4 |
| `resolveRootAttachment` | 9050 | function |  | 4 |
| `curvePointsToRootLocal` | 9090 | function |  | 2 |
| `curvePointsFromRootLocal` | 9102 | function |  | 2 |
| `syncRootAttachmentLocalCurves` | 9110 | function |  | 2 |
| `applyRootAttachmentLocalCurves` | 9126 | function |  | 2 |
| `createRootAttachment` | 9157 | function |  | 7 |
| `syncRootAttachmentMetadata` | 9187 | function |  | 3 |
| `rootAttachmentToData` | 9214 | function |  | 2 |
| `rootAttachmentFromData` | 9242 | function |  | 3 |
| `downloadPreferencesAndPresets` | 9287 | function |  | 1 |
| `importedBooleanPreference` | 9320 | function |  | 11 |
| `loadPreferencesAndPresets` | 9368 | function |  | 2 |
| `handlePreferencesAndPresetsFile` | 9438 | function |  | 1 |
| `openHairProjectFile` | 9482 | function |  | 4 |
| `dragContainsApplicationFile` | 9540 | function |  | 3 |
| `safelyRememberRecentProject` | 9549 | function |  | 2 |
| `renderRecentProjectsMenu` | 9558 | function |  | 4 |
| `openDroppedApplicationFilePrompt` | 9590 | function |  | 3 |
| `closeDroppedApplicationFilePrompt` | 9615 | function |  | 2 |
| `confirmDroppedApplicationFile` | 9619 | function |  | 2 |
| `pushUndoState` | 9635 | function |  | 71 |
| `undoLastAction` | 9642 | function |  | 2 |
| `redoLastAction` | 9659 | function |  | 2 |
| `updateHistoryButtons` | 9676 | function |  | 8 |
| `resetTransientInteractionsForStateRestore` | 9681 | function |  | 2 |
| `resetEditableSceneForStateRestore` | 9701 | function |  | 2 |
| `restoreSharedStateForStateRestore` | 9708 | function |  | 2 |
| `restoreSceneCollectionsForStateRestore` | 9747 | function |  | 2 |
| `validateSelectionAfterStateRestore` | 9773 | function |  | 2 |
| `reapplySelectionAfterStateRestore` | 9805 | function |  | 2 |
| `finalizeStateRestore` | 9846 | function |  | 2 |
| `restoreState` | 9853 | function |  | 4 |
| `disposeAllEditableObjects` | 9877 | function |  | 2 |
| `restoreLock` | 9898 | function |  | 4 |
| `restoreGuide` | 10122 | function |  | 2 |
| `vectorToData` | 10183 | function |  | 25 |
| `dataToVector` | 10187 | function |  | 22 |
| `frameToData` | 10191 | function |  | 2 |
| `frameFromData` | 10203 | function |  | 2 |
| `average` | 10215 | function |  | 3 |
| `fitPointAttributes` | 10219 | function |  | 6 |
| `rebuildCurveObjects` | 10248 | function |  | 5 |
| `createCurvePoints` | 10260 | function |  | 2 |
| `nextClumpName` | 10270 | function |  | 3 |
| `initializeClumpShape` | 10277 | function |  | 5 |
| `stableClumpVariation` | 10288 | function |  | 3 |
| `createClumpFromLocks` | 10300 | function |  | 4 |
| `addLockToClump` | 10325 | function |  | 4 |
| `pointerToNdc` | 10381 | function |  | 1 |
| `gridProfileSkipCol` | 10397 | function |  | 1 |
| `clumpDirectMembers` | 10421 | function |  | 3 |
| `clumpMembersForGuide` | 10426 | function |  | 6 |
| `clumpGuideForLock` | 10430 | function |  | 10 |
| `proceduralGuideForLock` | 10435 | function |  | 6 |
| `proceduralAccessoryMembersForGuide` | 10442 | function |  | 5 |
| `proceduralBranchMembersForGuide` | 10449 | function |  | 3 |
| `proceduralBranchTemplatesForGuide` | 10456 | function |  | 2 |
| `proceduralBranchWorldPoints` | 10468 | function |  | 1 |
| `applyProceduralBranchSettings` | 10481 | function |  | 2 |
| `proceduralAccessoryMapsForGuide` | 10520 | function |  | 3 |
| `setProceduralAccessoryGeometry` | 10536 | function |  | 3 |
| `createProceduralAccessoryLock` | 10550 | function |  | 2 |
| `applyProceduralAccessorySettings` | 10602 | function |  | 2 |
| `clumpFrameAt` | 10653 | function |  | 5 |
| `commitClumpMemberRestState` | 10661 | function |  | 9 |
| `updateClumpMembers` | 10744 | function |  | 9 |
| `dissolveClump` | 10848 | function |  | 5 |
| `detachLockFromClump` | 10885 | function |  | 4 |
| `deselectStrands` | 10919 | function |  | 9 |
| `beginSelectionMarquee` | 10934 | function |  | 3 |
| `beginAltOrbit` | 10958 | function |  | 1 |
| `beginBlenderNavigation` | 10970 | function |  | 1 |
| `endBlenderNavigation` | 11015 | function |  | 1 |
| `prepareSelectPointerCapture` | 11023 | function |  | 1 |
| `endSelectPointerCapture` | 11029 | function |  | 1 |
| `applyAltClickCandidate` | 11035 | function |  | 2 |
| `finishBrushAltClick` | 11061 | function |  | 1 |
| `endAltOrbit` | 11074 | function |  | 2 |
| `dollyCameraByDrag` | 11081 | function |  | 2 |
| `fastDragMagnitude` | 11104 | function |  | 2 |
| `beginHoudiniZoomDrag` | 11110 | function |  | 1 |
| `updateHoudiniZoomDrag` | 11118 | function |  | 1 |
| `endHoudiniZoomDrag` | 11135 | function |  | 1 |
| `updateSelectionMarquee` | 11143 | function |  | 1 |
| `pointInsideSelectionMarquee` | 11160 | function |  | 3 |
| `selectPointsInMarquee` | 11168 | function |  | 2 |
| `pointKey` | 11194 | arrow |  | 2 |
| `objectSelectionScreenBounds` | 11225 | function |  | 2 |
| `objectInsideSelectionMarquee` | 11262 | function |  | 3 |
| `projectedPoint` | 11279 | arrow |  | 1 |
| `selectObjectsInMarquee` | 11308 | function |  | 2 |
| `finishSelectionMarquee` | 11353 | function |  | 2 |
| `strandSplitProfileData` | 11377 | function |  | 2 |
| `strandSplitControlPoint` | 11390 | function |  | 1 |
| `panelSplitControlPoint` | 11426 | function |  | 3 |
| `panelWidthAt` | 11443 | arrow |  | 3 |
| `panelThicknessAt` | 11450 | arrow |  | 3 |
| `strandControlPointRaycast` | 11483 | function |  | 1 |
| `strandControlPointFrame` | 11518 | function |  | 4 |
| `strandControlPointHitFromEvent` | 11550 | function |  | 3 |
| `createCurveObjects` | 11608 | function |  | 4 |
| `strandWidthEdgeFrameAt` | 11729 | function |  | 5 |
| `transportedStrandWidthEdgeFrame` | 11736 | function |  | 2 |
| `strandWidthEdgeSample` | 11745 | function |  | 3 |
| `strandWidthEdgePoints` | 11768 | function |  | 2 |
| `sculptBrushDebugRaycast` | 11782 | arrow |  | 0 |
| `updateCurveObjects` | 11784 | function |  | 25 |
| `pointUpDirection` | 11979 | function |  | 2 |
| `curveFrameAtPoint` | 11983 | function |  | 4 |
| `curveFrameAt` | 12004 | function |  | 3 |
| `strandTwistAt` | 12024 | function |  | 6 |
| `controlPointRotationAt` | 12029 | function |  | 3 |
| `strandProfileTwistAt` | 12033 | function |  | 2 |
| `strandFrameAt` | 12039 | function |  | 1 |
| `curveFrameAtSnapshot` | 12045 | function |  | 3 |
| `outwardNormalAtPoint` | 12064 | function |  | 6 |
| `sampledSurfaceNormal` | 12127 | function |  | 2 |
| `guidedNormalAt` | 12143 | function |  | 4 |
| `twistFromHandle` | 12162 | function |  | 3 |
| `signedAngleAroundAxis` | 12183 | function |  | 4 |
| `handleColor` | 12190 | function |  | 2 |
| `isAffectedCurvePoint` | 12213 | function |  | 2 |
| `syncLockFromCurve` | 12219 | function |  | 18 |
| `rebuildLockGeometry` | 12249 | function |  | 8 |
| `flushPendingLockGeometryUpdates` | 12277 | function |  | 7 |
| `updateLockGeometry` | 12290 | function |  | 34 |
| `setGroupColorView` | 12311 | function |  | 2 |
| `createUvCheckerTexture` | 12321 | function |  | 3 |
| `ensureUvCheckerForLock` | 12357 | function |  | 4 |
| `removeUvCheckerFromLock` | 12390 | function |  | 3 |
| `invalidateUvInspector` | 12405 | function |  | 7 |
| `uvInspectorRecord` | 12409 | function |  | 1 |
| `uvInspectorRecords` | 12448 | function |  | 2 |
| `drawUvInspectorGrid` | 12452 | function |  | 2 |
| `renderUvInspector` | 12486 | function |  | 3 |
| `setUvCheckerEnabled` | 12545 | function |  | 3 |
| `strandViewportBaseColor` | 12562 | function |  | 3 |
| `strandMirrorPartnerHighlighted` | 12597 | function |  | 3 |
| `syncStrandSelectionOutline` | 12603 | function |  | 2 |
| `applyLockedStrandPalette` | 12614 | function |  | 2 |
| `syncLockedStrandWireVisual` | 12623 | function |  | 6 |
| `setStrandSelectionVisual` | 12632 | function |  | 4 |
| `proceduralParentOutlineVisible` | 12648 | function |  | 2 |
| `syncProceduralParentVisibility` | 12655 | function |  | 7 |
| `updateStrandSelectionHighlightForLock` | 12664 | function |  | 2 |
| `updateStrandSelectionHighlight` | 12668 | function |  | 7 |
| `refreshStrandCurveSelectionVisuals` | 12672 | function |  | 2 |
| `resetGuideSelectionVisuals` | 12685 | function |  | 2 |
| `refreshStrandSelectionConsumers` | 12705 | function |  | 3 |
| `selectLock` | 12738 | function |  | 31 |
| `deselectStrandsForGuideEditor` | 12800 | function |  | 1 |
| `syncGroupInputs` | 12811 | function |  | 2 |
| `topologyStatsForLock` | 12844 | function |  | 4 |
| `formatTopologyStats` | 12852 | function |  | 5 |
| `updateTopologyStats` | 12856 | function |  | 15 |
| `normalizeStrandDimensions` | 12890 | function |  | 3 |
| `strandBaseWidth` | 12904 | function |  | 5 |
| `strandWidthDimension` | 12908 | function |  | 5 |
| `strandDepthDimension` | 12916 | function |  | 8 |
| `setStrandWidthDimension` | 12924 | function |  | 2 |
| `setStrandDepthDimension` | 12946 | function |  | 4 |
| `syncShapeDimensionInputs` | 12962 | function |  | 4 |
| `syncCreationShapeInputs` | 12998 | function |  | 2 |
| `syncViewportDrawSettings` | 13036 | function |  | 4 |
| `syncStrandSplitInputs` | 13053 | function |  | 4 |
| `syncHairCardControls` | 13062 | function |  | 6 |
| `syncProceduralAccessoryEditControls` | 13070 | function |  | 3 |
| `updateAttributeEditorMode` | 13109 | function |  | 10 |
| `pinActiveToolSettingsPanel` | 13259 | function |  | 2 |
| `curveLatticeForGroup` | 13282 | function |  | 2 |
| `filterCurveLatticesToGroup` | 13300 | function |  | 5 |
| `createStandaloneCurveLatticeGuide` | 13345 | function |  | 2 |
| `showCurveLatticeForGroup` | 13362 | function |  | 2 |
| `selectStrandGroup` | 13399 | function |  | 3 |
| `selectCurvePoint` | 13441 | function |  | 3 |
| `updateSelectedPointLabel` | 13455 | function |  | 12 |
| `syncInputs` | 13468 | function |  | 13 |
| `syncClumpGuidePanel` | 13514 | function |  | 3 |
| `getSelectedLock` | 13541 | function |  | 88 |
| `selectedLocksInOrder` | 13545 | function |  | 28 |
| `lockStrands` | 13551 | function |  | 3 |
| `lockSelectedStrands` | 13584 | function |  | 2 |
| `unlockStrands` | 13590 | function |  | 3 |
| `unlockAllStrands` | 13605 | function |  | 2 |
| `strandEditFamily` | 13609 | function |  | 7 |
| `compatibleSelectedLocks` | 13614 | function |  | 4 |
| `selectedEditRoots` | 13621 | function |  | 2 |
| `editSelectedLocks` | 13634 | function |  | 16 |
| `multiEditValuesEqual` | 13667 | function |  | 2 |
| `setMixedControl` | 13676 | function |  | 28 |
| `syncMultiStrandInputs` | 13693 | function |  | 16 |
| `values` | 13709 | arrow |  | 35 |
| `selectedRebuildableCurves` | 13789 | function |  | 5 |
| `createCompoundStrand` | 13796 | function |  | 1 |
| `refreshRebuildCurveDialog` | 13857 | function |  | 7 |
| `openRebuildCurveDialog` | 13870 | function |  | 1 |
| `rebuildSelectedCurves` | 13884 | function |  | 2 |
| `selectionCanBecomeClump` | 13923 | function |  | 3 |
| `createClumpFromSelection` | 13928 | function |  | 2 |
| `cleanSelectionSets` | 13940 | function |  | 2 |
| `createSelectionSetFromSelection` | 13945 | function |  | 2 |
| `selectionSetById` | 13956 | function |  | 5 |
| `selectionSetCanEditFromSelection` | 13960 | function |  | 4 |
| `editSelectionSetFromSelection` | 13969 | function |  | 3 |
| `deleteSelectionSet` | 13989 | function |  | 2 |
| `selectSelectionSet` | 13998 | function |  | 2 |
| `deleteSelectedStrands` | 14008 | function |  | 3 |
| `deleteGuide` | 14016 | function |  | 3 |
| `deleteSelectedGuide` | 14039 | function |  | 3 |
| `hasDeletableSelection` | 14044 | function |  | 2 |
| `deleteCurrentSelection` | 14052 | function |  | 3 |
| `hideOutlinerContextMenu` | 14060 | function |  | 16 |
| `outlinerLockTargets` | 14065 | function |  | 3 |
| `showOutlinerContextMenu` | 14092 | function |  | 7 |
| `setPullMoveEnabled` | 14172 | function |  | 2 |
| `setProceduralDrawExperimentalEnabled` | 14180 | function |  | 5 |
| `setNavigationTipsEnabled` | 14195 | function |  | 5 |
| `configureNavigationMouseButtons` | 14202 | function |  | 3 |
| `syncNavigationModifierLocks` | 14215 | function |  | 7 |
| `setNavigationStyle` | 14220 | function |  | 5 |
| `applyCameraSmoothingPreference` | 14236 | function |  | 4 |
| `setCameraSmoothingEnabled` | 14251 | function |  | 5 |
| `setCameraSmoothingStrength` | 14257 | function |  | 5 |
| `setScaleSensitivity` | 14265 | function |  | 3 |
| `setToolTipsEnabled` | 14273 | function |  | 5 |
| `setCompactToolButtonsEnabled` | 14280 | function |  | 5 |
| `setViewportStatisticsEnabled` | 14289 | function |  | 5 |
| `setTwistCurveAllStrandsPreviewEnabled` | 14297 | function |  | 5 |
| `setLayerColorShiftsEnabled` | 14312 | function |  | 5 |
| `setOutlinerFolderColorsEnabled` | 14321 | function |  | 5 |
| `sideNamingDisplayId` | 14330 | function |  | 2 |
| `strandRegionDisplayLabel` | 14343 | function |  | 6 |
| `updateSideNamingLabels` | 14361 | function |  | 2 |
| `setSideNamingPerspective` | 14388 | function |  | 5 |
| `setControlPointDisplaySize` | 14397 | function |  | 6 |
| `scaleHexColor` | 14409 | function |  | 3 |
| `setViewportBackgroundColor` | 14414 | function |  | 7 |
| `setDefaultHairShader` | 14436 | function |  | 5 |
| `setPreferenceCategory` | 14442 | function |  | 4 |
| `openPreferencesDialog` | 14469 | function |  | 1 |
| `savePreferencesDialog` | 14497 | function |  | 1 |
| `cancelPreferencesDialog` | 14521 | function |  | 3 |
| `duplicatePlacementTarget` | 14550 | function |  | 2 |
| `proceduralDuplicateSourceSnapshots` | 14577 | function |  | 4 |
| `proceduralDuplicateEligibleLock` | 14581 | function |  | 1 |
| `selectedProceduralDuplicateSources` | 14591 | function |  | 3 |
| `updateProceduralDuplicateSpacingNote` | 14596 | function |  | 3 |
| `clearProceduralDuplicatePreview` | 14608 | function |  | 3 |
| `closeProceduralDuplicateDialog` | 14619 | function |  | 7 |
| `openProceduralDuplicateDialog` | 14627 | function |  | 1 |
| `proceduralDuplicateCopySnapshot` | 14644 | function |  | 2 |
| `proceduralDuplicateHeadCenter` | 14665 | function |  | 4 |
| `hideProceduralDuplicateArcPreview` | 14676 | function |  | 8 |
| `proceduralDuplicateReferencePoints` | 14682 | function |  | 2 |
| `updateProceduralDuplicateArcPreview` | 14688 | function |  | 4 |
| `applyProceduralDuplicateBlend` | 14721 | function |  | 3 |
| `buildEvenlySpacedProceduralDuplicates` | 14876 | function |  | 2 |
| `rebuildProceduralDuplicatePreview` | 14978 | function |  | 5 |
| `confirmProceduralDuplicatePreview` | 15019 | function |  | 2 |
| `updateDuplicatePlacement` | 15046 | function |  | 2 |
| `beginDuplicatePlacement` | 15110 | function |  | 3 |
| `beginProceduralDuplicatePlacement` | 15174 | function |  | 2 |
| `confirmDuplicatePlacement` | 15215 | function |  | 1 |
| `cancelDuplicatePlacement` | 15252 | function |  | 4 |
| `outlinerClumpLocks` | 15278 | function |  | 10 |
| `handleOutlinerClumpDrop` | 15282 | function |  | 3 |
| `createOutlinerStrandButton` | 15305 | function |  | 4 |
| `createOutlinerCurveSurface` | 15391 | function |  | 2 |
| `createOutlinerClump` | 15487 | function |  | 2 |
| `selectionSetMatchesCurrentSelection` | 15569 | function |  | 2 |
| `createSelectionSetsOutlinerFolder` | 15576 | function |  | 2 |
| `renderLockList` | 15655 | function |  | 50 |
| `updateCount` | 15809 | function |  | 16 |
| `captureInputUndo` | 15818 | function |  | 1 |
| `bindUndoCapture` | 15824 | function |  | 37 |
| `bindLockInput` | 15835 | function |  | 2 |
| `applyValue` | 15852 | arrow |  | 2 |
| `applyUniformTransformScale` | 16171 | function |  | 2 |
| `applyReducedTransformScale` | 16188 | function |  | 2 |
| `applyTransformPrecision` | 16227 | function |  | 2 |
| `updateTransformScalePointer` | 16256 | function |  | 1 |
| `beginProceduralAccessoryEdit` | 17253 | function |  | 4 |
| `updateSelectedProceduralAccessories` | 17258 | function |  | 4 |
| `syncDrawCurlControls` | 17313 | function |  | 5 |
| `handleLiveSurfaceChange` | 17361 | function |  | 1 |
| `selectedBranchChildLock` | 17652 | function |  | 4 |
| `updateBranchBridgeSliderInputs` | 17656 | function |  | 2 |
| `initPanelResizeHandles` | 17762 | function |  | 2 |
| `applyWidth` | 17768 | arrow |  | 2 |
| `restoreWidth` | 17775 | arrow |  | 2 |
| `bindResize` | 17783 | arrow |  | 2 |
| `onMove` | 17792 | arrow |  | 0 |
| `onUp` | 17796 | arrow |  | 0 |
| `updateSnappedFloatingPanels` | 17813 | function |  | 2 |
| `initFloatingPanelControls` | 17822 | function |  | 2 |
| `detach` | 17831 | arrow |  | 22 |
| `endDrag` | 17869 | arrow |  | 0 |
| `endResize` | 17901 | arrow |  | 0 |
| `updateSculptBrushDockCompact` | 17912 | function |  | 3 |
| `selectPatchNotesVersion` | 18046 | function |  | 3 |
| `toggleCapsuleGuideTool` | 18277 | function |  | 1 |
| `activateCapsuleGuideDrawTool` | 18283 | function |  | 1 |
| `createCurveLatticeGuideFromUi` | 18290 | function |  | 1 |
| `deleteLocks` | 18857 | function |  | 8 |
| `disposeCurveObjects` | 18935 | function |  | 4 |
| `resize` | 18997 | function |  | 3 |
| `handleViewportPointerMove` | 19008 | function |  | 1 |
| `blockProportionalSizingEvent` | 19019 | function |  | 1 |
| `updateLightAngleFromInputs` | 19025 | function |  | 2 |
| `startViewSnap` | 19039 | function |  | 3 |
| `beginViewSnapFromActiveOrbit` | 19069 | function |  | 3 |
| `trackViewportPointerDown` | 19086 | function |  | 1 |
| `trackViewportPointerMove` | 19102 | function |  | 1 |
| `clearViewportPointer` | 19110 | function |  | 1 |
| `updateViewSnap` | 19115 | function |  | 1 |
| `nearestCardinalAxis` | 19151 | function |  | 5 |
| `cardinalAxisKey` | 19165 | function |  | 4 |
| `steppedDragAmount` | 19169 | function |  | 3 |
| `snapCameraToCardinalAxis` | 19175 | function |  | 4 |
| `endViewSnap` | 19191 | function |  | 4 |
| `activateStrandControlPoint` | 19201 | function |  | 2 |
| `refreshStrandControlPointSelection` | 19251 | function |  | 4 |
| `addStrandControlPointSelection` | 19278 | function |  | 2 |
| `removeStrandControlPointSelection` | 19295 | function |  | 3 |
| `sampleStrandPointNormal` | 19309 | function |  | 2 |
| `sampleStrandPointVectors` | 19319 | function |  | 3 |
| `remapStrandPointSelectionAfterRemoval` | 19325 | function |  | 2 |
| `resampleStrandCurveData` | 19336 | function |  | 4 |
| `resampleMatchingVectors` | 19342 | arrow |  | 3 |
| `finishStrandCurveTopologyChange` | 19381 | function |  | 4 |
| `removeStrandCurvePoint` | 19392 | function |  | 2 |
| `closestStrandCurveParameter` | 19405 | function |  | 1 |
| `insertStrandCurvePoint` | 19434 | function |  | 2 |
| `curvePointTopologyCursorAvailable` | 19451 | function |  | 2 |
| `selectionModifierCursorAvailable` | 19461 | function |  | 3 |
| `clearCurvePointTopologyCursor` | 19477 | function |  | 6 |
| `updateCurvePointTopologyCursor` | 19484 | function |  | 4 |
| `finishCurvePointInsertion` | 19507 | function |  | 1 |
| `finishPointRemoval` | 19522 | function |  | 1 |
| `isHairCreateTool` | 19541 | function |  | 4 |
| `syncStrandHoverOutline` | 19545 | function |  | 1 |
| `pointerOverTaperEditor` | 19558 | function |  | 2 |
| `updateStrandBrushHover` | 19565 | function |  | 1 |
| `strandControlPointHit` | 19589 | function |  | 3 |
| `beginStrandWidthEdgeDrag` | 19593 | function |  | 1 |
| `updateStrandWidthEdgeDrag` | 19671 | function |  | 1 |
| `finishStrandWidthEdgeDrag` | 19705 | function |  | 2 |
| `setHoveredStrandWidthEdge` | 19745 | function |  | 8 |
| `updateStrandWidthEdgeHover` | 19758 | function |  | 1 |
| `setHoveredControlPoint` | 19797 | function |  | 7 |
| `visibleControlPointHoverTargets` | 19810 | function |  | 2 |
| `updateControlPointHover` | 19846 | function |  | 1 |
| `animate` | 20461 | function |  | 2 |
| `syncCompactSidebarLayout` | 20492 | function |  | 4 |
| `setOutlinerPanelCollapsed` | 20511 | function |  | 5 |
| `setAttributeEditorPanelCollapsed` | 20517 | function |  | 3 |
| `setAttributeEditorTab` | 20523 | function |  | 6 |
