...
- [ ] **阶段 3b：核心场景 store**（selection/outliner/sculpt/edit 的 ~40 个高频 let → modules/core/scene-store.js，复用 io/project-state.js 快照机制；app.js 保留 getter/setter 兼容层；独立 commit + verify）
